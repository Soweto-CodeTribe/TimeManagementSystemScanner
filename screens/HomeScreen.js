      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.statsGrid}>
          {activeStats === "monthly" ? (
            <>
              {renderStatsCard(85, "February", "Your daily attendance rate", "15-20")}
              {renderStatsCard(92, "March", "Your daily attendance rate", "20-25")}
              {renderStatsCard(78, "April", "Your daily attendance rate", "12-15")}
              {renderStatsCard(88, "May", "Your daily attendance rate", "18-22")}
            </>
          ) : (
            <>
              {renderStatsCard(90, "2024-2025", "Yearly attendance rate", "280-300")}
